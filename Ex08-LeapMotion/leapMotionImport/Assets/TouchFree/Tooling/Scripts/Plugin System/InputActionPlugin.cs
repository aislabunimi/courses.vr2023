...
namespace Ultraleap.TouchFree.Tooling
{
    ...
    public abstract class InputActionPlugin : MonoBehaviour
    {
        ...
        public InputAction? RunPlugin(InputAction _inputAction)
        {
            InputAction? modifiedInputAction = ModifyInputAction(_inputAction);
        ...
        protected abstract InputAction? ModifyInputAction(InputAction _inputAction);

        // Function: TransmitInputAction
        // To be used to Invoke the <InputActionOutput> event from any child class of this base.
        internal void TransmitInputAction(InputAction _inputAction)
        {
